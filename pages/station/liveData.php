				...
				<table style="margin-left:auto;margin-right:auto; width:90%">
					...
					<tr>
						...
						<td class="current" colspan="2">
							<span class="detail"><span class="mticon-<?php echo strtolower(windAbb($direction))?> unitsImg tooltip" title="<?php echo lang("wind direction",'c')?>"></span><?php echo $direction."° ( ".lang("direction".windAbb($direction),'u')." )" ?></span>
						</td>
						<td class="current">
