...
<html>
<head>
	<title><?php echo lang("live conditions","c")?></title>
	<?php metaHeader()?>
...
<script type="text/javascript">
        $(document).ready(function () {       
            ...
            $('#gaugeGust').jqxGauge({
                ...
                ticksMinor: { 
					interval: <?php echo round(($windGaugeMax-$windGaugeMin)/20,1)?>, 
					size: '5%',
					style: { 
						stroke: '#<?php echo $color_schemes[$design]['100']?>', 
						'stroke-width': '1px', 
                ...
                ticksMajor: { 
					interval: <?php echo round(($windGaugeMax-$windGaugeMin)/10,1)?>, 
					size: '10%',
					style: { 
						stroke: '#<?php echo $color_schemes[$design]['100']?>', 
						'stroke-width': '3px', 
