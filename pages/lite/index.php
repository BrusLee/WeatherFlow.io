...
<html> 
    ...
    <body> 
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-2 col-sm-4">
                        ...
                        <h2 class="text-center"><?php echo number_format(convertT($current['T']),1,".","")?></h2>
                    ...
                    ?>
                            <div class="col-md-2 col-sm-4">
                                ...
                                <h2 class="text-center"><?php echo number_format(convertT($current['S']),0,".","")?></h2>
                    ...
                    <div class="col-md-2 col-sm-4">
                        ...
                        <h2 class="text-center"><?php echo number_format(convertT($current['A']),1,".","")?></h2>
                        <p class="text-center"><?php echo unitFormatter($displayTempUnits)?></p>
                    </div>
                    <div class="col-md-2 col-sm-4">
                        <h2 class="text-center"><span class="mticon-dewpoint"></span></h2>
                        <h2 class="text-center"><?php echo number_format(convertT($current['D']),1,".","")?></h2>
                        <p class="text-center"><?php echo unitFormatter($displayTempUnits)?></p>
                    </div>
                </div>
            </div>
								...
								<table style="margin:0 auto" cellspacing="0" cellpadding="0">
									...
									<tr>
										<td colspan="3" style="text-align:center">
											<a style="color:white!important" href="<?php echo $meteotemplateURL?>">www.meteotemplate.com</a>
										</td>
									</tr>
									<tr>
										<td colspan="3" style="text-align:center">
		...
		<script src="http://www.cvicenipromaminky.cz/web/lib/easing/easing.js"></script>
        <script> 
