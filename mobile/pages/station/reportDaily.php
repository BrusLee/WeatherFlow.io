<?php
	...
	$dayYesterdayURL = $pageURL.$path."mobile/pages/station/redirect.php?url=reportDaily.php?d=".(date("d",$day - 60 * 60 * 24))."%26m=".(date("m",$day - 60 * 60 * 24))."%26y=".(date("Y",$day - 60 * 60 * 24));
	if(($day+60*60*24)<=time()){ // prevent showing tomorrow if current day is today
		$dayTomorrowURL = $pageURL.$path."/mobile/pages/station/redirect.php?url=reportDaily.php?d=".(date("d",$day + 60 * 60 * 24))."%26m=".(date("m",$day + 60 * 60 * 24))."%26y=".(date("Y",$day + 60 * 60 * 24));
	}
