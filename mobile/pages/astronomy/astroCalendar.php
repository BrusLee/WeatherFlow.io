					...
					<table style="width:100%;table-layout:fixed">
						<tr>
							<td style="width:5%;text-align:left;font-size:0.8em">
								<a href="<?php echo $pageURL.$path?>pages/station/redirect.php?url=<?php echo $pdfURLMonth?>" target="_blank"><span class="fa fa-file-pdf-o tooltip pdfLink" title="PDF"></span><br><?php echo lang("month".($m*1),"c")." ".$y?></a>
							</td>
							...
							<td style="width:5%;text-align:right;font-size:0.8em">
								<a href="<?php echo $pageURL.$path?>pages/station/redirect.php?url=<?php echo $pdfURLYear?>&text=<?php echo $pdfURLText?>" target="_blank"><span class="fa fa-file-pdf-o tooltip pdfLink" title="PDF"></span><br><?php echo $y?></a>
							</td>
						</tr>
					</table>
				</div>
